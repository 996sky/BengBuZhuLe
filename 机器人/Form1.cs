...
namespace 机器人
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.FillEllipse(b1,0+x,0+y,250+x,250+y);//面部
            g.DrawEllipse(p2, 0 + x, 0 + y, 250 + x, 250 + y);
            ...
            g.FillEllipse(b2, 60 + x, 75+y,50,90);
            ...
            g.FillPie(b1, 180 + x, 100 + y, 50, 55, 0, -180);//眼睛

            g.FillPie(b, 59 + x, 123 + y, 176, 147, 0, 180);
            g.FillPie(b3, 60 + x, 145 + y, 175, 130, 0, 180);
            g.DrawLine(p1, 60 + x, 197+y, 235+x, 197+y);//嘴

            g.FillEllipse(b4, 115 + x, 135 + y, 60, 40);
            g.FillEllipse(b5, 125 + x, 145 + y, 10, 10);//鼻子


            g.FillEllipse(b10, 241 + x, 85 + y, 58, 58);
            ...
            g.FillEllipse(b8, 262 + x, 55 + y, 20, 50);//水滴
